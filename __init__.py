...
from .nodes.Debug import NODE_CLASS_MAPPINGS as debug_map, NODE_DISPLAY_NAME_MAPPINGS as debug_display_map
NODE_CLASS_MAPPINGS.update(debug_map)
NODE_DISPLAY_NAME_MAPPINGS.update(debug_display_map)

from .nodes.Pre import NODE_CLASS_MAPPINGS as pre_map, NODE_DISPLAY_NAME_MAPPINGS as pre_display_map
